...
comb_methods.update(from_file(folder,'frequentist'))
...
koi=get_koi(koi_file)
settings.labeldict['koi']=settings.unsure_value
for i in koi:
    if compare_labels[i]!='planet':
        compare_labels[i]='koi'
