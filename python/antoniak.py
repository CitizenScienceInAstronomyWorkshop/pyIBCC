'''
From https://gist.github.com/tdhopper/80dbf2582e12ab5d08e1

@author: https://gist.github.com/tdhopper
...
def expectation_pn(alpha, pn_arr):
    Es = 0
    for n, pn in enumerate(pn_arr):
        Es += expectation(alpha, n+1) * pn
